...
public class UserApiControllerAuthTest {
    ...
    @Test
    public void
    unauthenticated_cannot_list_users() throws Exception {
    ...
    public void admin_can_list_users() throws Exception {
        this.mockMvc.perform(get("/api/users").accept(MediaType.APPLICATION_JSON).header("Authorization", basicAuth("admin", "admin")))
