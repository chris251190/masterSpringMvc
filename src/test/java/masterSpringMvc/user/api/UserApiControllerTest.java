...
public class UserApiControllerTest {
    ...
    @Test
    public void should_delete_user() throws
            Exception {
    ...
    public void should_return_not_found_when_deleting_unknown_user() throws Exception {
        this.mockMvc.perform(delete("/api/user/nonexisting@mail.com").accept(MediaType.APPLICATION_JSON))
    ...
    public void put_should_update_existing_user() throws Exception {
        ...
        this.mockMvc.perform(put("/api/user/bob@spring.io").content(JsonUtil.toJson(user))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
        assertThat(userRepository.findAll())
                .extracting(User::getEmail)
